function tool_cpm_plot_l( r_int,r_ext,phi_int,phi_ext,n_th,label_opt,cur_time_i,par_dt )
...
figure;
hold on
[C1,h1]=contour(x_int,y_int,data_int',[2,3,4,5],'b');
[C2,h2]=contour(x_ext,y_ext,data_ext',[1.1,1.3,1.5,2],'b');
...
jpg_name=strcat('l_fig_t_c_',num2str(cur_time_i),'.fig');
saveas(gcf,jpg_name);
hold off
drawnow
