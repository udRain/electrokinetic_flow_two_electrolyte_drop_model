function tool_psi_plot( r_int,r_ext,psi_int,psi_ext,psi_int_lt,psi_ext_lt,n_th,label_opt,cur_time_i,par_dt )
...
[C1,h1]=contour(x_int,y_int,data_int,[-0.001,0.001],'b');
[C3,h3]=contour(x_int,y_int,data_int_lt,[-0.001,0.001],'r--');
[C2,h2]=contour(x_ext,y_ext,data_ext,[0.005,0.01,-0.005,-0.01],'b');
...
jpg_name=strcat('fig_t_psi_',num2str(cur_time_i),'.fig');
saveas(gcf,jpg_name);
hold off
drawnow
